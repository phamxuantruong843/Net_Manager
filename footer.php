  ...
  <div class="container">
    <div class="copyright-wrap d-md-flex py-4">
      <div class="mr-md-auto text-center text-md-left">
        <div class="copyright">
          <h3>TRƯỜNG ĐẠI HỌC CÔNG NGHỆ HÀ NỘI</h3>
          <p>
            Địa chỉ:Tòa E3 144 Xuân Thủy, Cầu Giấy, Hà Nội<br />
            Tel: (+84) 02703822141 - Fax: (+84) 02703821003<br />
            Sinh viên thực hiện: Phạm Xuân Trường, Dương Đình Mạnh, Đoàn Mạnh Dương<br />
          </p>
        </div>
      </div>
